      ...
      <div className="container">
        <div className="brand">
          <Link to="/">
            <img
              className="logo"
              src="https://res.cloudinary.com/dyx3a8vxv/image/upload/v1632977321/501-5010201_online-shopping-comments-online-shopping-icon-png_xddae5.jpg"
        ...
        <div className="cart">
          ...
          <a className="cart-icon" href="#" onClick={handleCartButton}>
            <img
              ...
              src="https://res.cloudinary.com/dyx3a8vxv/image/upload/v1632978380/download_ezcy9p.png"
              alt="Cart"
            />
            {cartQuantity ? (
